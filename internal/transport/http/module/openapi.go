...
func metadataOpenAPIOperations() map[string]map[string]any {
	...
	return map[string]map[string]any{
		"GET /tenant-admin/metadata/definitions/{resourceType}":               {"operationId": "listMetadataDefinitions", "tags": []string{"Metadata Definitions"}, "summary": "List projected definitions by source-owned resource type", "security": security, "parameters": []any{path("resourceType"), query("workspace_id")}, "responses": jsonResponse("Projected metadata definitions", map[string]any{"type": "object", "required": []string{"definitions", "resource_type"}, "properties": map[string]any{"definitions": map[string]any{"type": "array", "items": definition}, "resource_type": map[string]any{"type": "string"}}})},
		"GET /tenant-admin/metadata/definitions/{resourceType}/{resourceKey}": {"operationId": "getMetadataDefinition", "tags": []string{"Metadata Definitions"}, "summary": "Get one projected source-owned definition", "security": security, "parameters": []any{path("resourceType"), path("resourceKey")}, "responses": jsonResponse("Projected metadata definition", definition)},
		"GET /tenant-admin/metadata/localized-texts":                          {"operationId": "listMetadataLocalizedTexts", "tags": []string{"Metadata Localization"}, "summary": "List projected localized text", "security": security, "parameters": metadataLocalizationQueryParameters(query), "responses": jsonResponse("Localized text", map[string]any{"type": "object", "required": []string{"localized_texts"}, "properties": map[string]any{"localized_texts": map[string]any{"type": "array", "items": localized}}})},
		"GET /tenant-admin/metadata/localized-texts/coverage":                 {"operationId": "getMetadataLocalizationCoverage", "tags": []string{"Metadata Localization"}, "summary": "Measure localization coverage with explicit fallback", "security": security, "parameters": []any{query("locale"), query("fallback_locale")}, "responses": jsonResponse("Localization coverage", modulecapability.JSONSchemaForGoValue(metadatasdk.LocalizedTextCoverage{}))},
		"GET /tenant-admin/metadata/localized-texts/export":                   metadataExportOperation("exportMetadataLocalizedTextsCSV", "text/csv", metadataLocalizationQueryParameters(query), security),
		"GET /tenant-admin/metadata/localized-texts/export.xlsx":              metadataExportOperation("exportMetadataLocalizedTextsXLSX", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", metadataLocalizationQueryParameters(query), security),
		"GET /dictionaries/{dictionaryKey}/items":                             {"operationId": "listMetadataDictionaryItems", "tags": []string{"Metadata Dictionaries"}, "summary": "Resolve localized items from one projected dictionary", "security": security, "parameters": []any{path("dictionaryKey"), query("locale")}, "responses": jsonResponse("Localized dictionary items", modulecapability.JSONSchemaForGoValue(metadatasdk.DictionaryItems{}))},
	}
}
